...
import omurkumru.com.dataBindingExample.databinding.DialogChooseQuantityBinding;
...
public class ChooseQuantityDialog extends DialogFragment {
    ...
    public AdapterView.OnItemClickListener mOnItemClickListener = new AdapterView.OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
            ...
            iMainActivity.setQuantity(Integer.valueOf((String ) adapterView.getItemAtPosition(i)));
            getDialog().dismiss();
        }
    };
